...
return array (
  ...
  'Unable to import "{alias}". Please check your server configuration to make sure you are allowed to change PHP include_path.' => '无法导入 "{alias}"。请检查你的服务器配置，以确保允许你的程序更改PHP的include_path设置。',
  'Unable to resolve the request "{route}".' => '无法解析请求 "{route}"。',
  'Unknown type "{type}".' => '未知类型 "{type}"。',
  'Your request is invalid.' => '你的请求无效。',
  ...
  'View file "{file}" does not exist.' => '名为 "{file}" 的 View 不存在.',
  'Yii application can only be created once.' => 'Yii 应用程序只能被产生一次.',
  'You are not authorized to perform this action.' => '你未被授权执行这个操作',
  'Your request is not valid.' => '无效请求',
  '{attribute} "{value}" has already been taken.' => '{attribute} {value} 已被使用.',
  ...
  '{attribute} is too long (maximum is {max} characters).' => '{attribute} 太长 (最大为{max}个字符).',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute} 太短 (最少为{min}个字符).',
